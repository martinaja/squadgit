...
const WeatherReport = () => {
	// Componente que trae los datos del clima
	...
	return (
		<div className="col-xl-6 card">
			<div className="container">
				<h1 className="text-center d-sm-flex justify-content-sm-center align-items-sm-end titulo">Reporte diario</h1>
				<div className="row ">
					<div className="col d-sm-flex justify-content-md-center fila "></div>
				</div>
							...
							<div className="div5">
								<div className="col">
									<div className="col col2">
										<img className="icono" src={values.img} alt="Icono"></img> 
									</div>
								</div>
							</div>
